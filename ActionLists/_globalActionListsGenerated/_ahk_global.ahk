...
Send Now timestampyyMMddHHmmss|rr||ahk|FormatTime, timestampyyMMddHHmmss, %A_now%,yyMMddHHmmss `n send, %timestampyyMMddHHmmss%
...
FileExist(wokingAbsDir_file1 ) ; R = READONLY A = ARCHIVE S = SYSTEM H = HIDDEN N = NORMAL D = DIRECTORY O = OFFLINE C = COMPRESSED T = TEMPORARY
