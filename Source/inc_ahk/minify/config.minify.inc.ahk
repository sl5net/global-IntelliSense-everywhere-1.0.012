...
g_config.editor := {  	tryThisEditorFirst: "Notepad", 	AHKStudioAHK : A_ScriptDir "\..\AHK-Studio\AHK-Studio.ahk", 	NotepadPPExe : "C:\Program Files\Notepad++\notepad++.exe", 	AutoGUIAHK : A_ScriptDir "\..\AutoGUI\AutoGUI.ahk" } ; possible values: Notepad, AHKStudio, AutoGUI 
