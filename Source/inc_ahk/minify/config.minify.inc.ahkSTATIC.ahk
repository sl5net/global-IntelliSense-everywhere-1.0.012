...
*/
; comments  
g_config.ScriptDir := "C:\gi10012\Source"
g_config.editor := {  	tryThisEditorFirst: "Notepad", 	AHKStudioAHK : "C:\gi10012\Source" "\..\AHK-Studio\AHK-Studio.ahk", 	NotepadPPExe : "C:\Program Files\Notepad++\notepad++.exe", 	AutoGUIAHK : "C:\gi10012\Source" "\..\AutoGUI\AutoGUI.ahk" } ; possible values: Notepad, AHKStudio, AutoGUI 
...
g_actionListDBfileAdress := "C:\gi10012\Source" "\actionListLearned.db"
actionList_isNotAProject_withoutExt  := removesSymbolicLinksFromFileAdress( "C:\gi10012\Source" "\..\actionLists\_globalActionListsGenerated\isNotAProject" )
...
g_config.sql := { 	select: {  		ignReg: "m)^((?!\bActionListID\b\s*[><=]).)*$" , 		ignIfWhereIsWithoutListID : false, 		showFilePrefix : false  	}, 	DB_Browser: "C:\Program Files (x86)\DB Browser for SQLite\DB Browser for SQLite.exe" } ; showFilePrefix useful if you want find out which select data supplies
